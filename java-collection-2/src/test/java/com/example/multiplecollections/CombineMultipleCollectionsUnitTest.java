package com.example.multiplecollections;
...
public class CombineMultipleCollectionsUnitTest {
    ...
    public void givenUsingApacheCommons_whenConcatenatingUsingUnion_thenCorrect() {
        Collection<String> collectionA = asList("S", "T");
        Collection<String> collectionB = asList("U", "V");
//        روش‌های کاربردی و دکوراتورها برای نمونه‌های Collection توسط کلاس CollectionUtils ارائه شده‌اند. متد ()union از این کلاس مجموعه‌ای را برمی‌گرداند که حاوی اتحاد نمونه‌های Iterable داده شده است.
