...
//قبلاً دیدیم که اکثر صف هایی که در جاوا با آنها روبرو می شویم از اصل FIFO پیروی می کنند.
//
//یکی از این موارد استثنا در این قانون PriorityQueue است. هنگامی که عناصر جدید در PriorityQueue درج می شوند، بر اساس ترتیب طبیعی آنها یا توسط یک مقایسه کننده تعریف شده که هنگام ساخت PriorityQueue ارائه می شود، مرتب می شوند.
//
