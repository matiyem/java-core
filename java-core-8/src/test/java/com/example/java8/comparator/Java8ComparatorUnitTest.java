package com.example.java8.comparator;
...
//        comparingInt فقط برای سلکتر های int است
    ...
    public void whenComparingLong_thenSortedByMobile() {
        //        comparingLong فقط برای سلکتر های long است
    ...
    public void whenComparingDouble_thenSortedBySalary() {
        //        comparingDouble فقط برای سلکتر های double است
...
//        naturalOrder بر اساس کد اسکی انجام میشود
    ...
    public void whenNullsFirst_thenSortedByNameWithNullsFirst() {
        Comparator<Employee> employeeNameComparator = Comparator.comparing(Employee::getName);
        //nullsFirst مقادیر null در ابتدا قرار میگیرند
    ...
    public void whenNullsLast_thenSortedByNameWithNullsLast() {
        Comparator<Employee> employeeNameComparator = Comparator.comparing(Employee::getName);
        //nullsLast مقادیر null در آخر قرار میگیرند
    ...
    public void whenThenComparing_thenSortedByAgeName() {
        //تابع thenComparing به ما این امکان را می دهد تا با ارائه کلیدهای مرتب سازی متعدد در یک دنباله خاص، ترتیب واژگانی مقادیر را تنظیم کنیم.
