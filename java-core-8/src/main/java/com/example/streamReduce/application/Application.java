package com.example.streamReduce.application;


import com.example.streamReduce.entities.User;
import com.example.streamReduce.utilities.NumberUtils;
...
public class Application {
    public static void main(String[] args) {
        ...
        List<User> users = Arrays.asList(new User("Johne", 30), new User("Julie", 35));
...
//        سمت چپ اسم کلاس مورد نظر-سمت راست اسم متد مورد نظر
