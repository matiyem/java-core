...
public class Java8StreamApiUnitTest {
    ...
    public void createStream_whenCreated_thenCorrect() {
        ...
        //آرگمان دوم رو را هم شامل میشود.خود 3 را هم شامل میشود
        ...
        //هیچ استریمی برای کاراکتر ها وجود ندارد پس برای استفاده از آن ها از intStream استفاده میکنیم
        ...
        //هنگامی که از سازنده استفاده می شود، نوع مورد نظر باید علاوه بر این در قسمت سمت راست عبارت مشخص شود، در غیر این صورت متد build() نمونه ای از Stream<Object> را ایجاد می کند:
        Stream<String> streamBuilder = Stream.<String> builder().add("a").add("b").add("c").build();
        assertEquals(3, streamBuilder.count());
        //generate یک متد بینهایت است اگر برای آن محدودیتی تعریف نشود تا زمانی که حافظه وجود دارد ساخته میشود
