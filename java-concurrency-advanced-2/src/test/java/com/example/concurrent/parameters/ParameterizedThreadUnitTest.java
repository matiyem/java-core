...
//        یکی از نکات مهمی که باید به خاطر بسپارید این است که پارامترها را به طور موثر نهایی نگه دارید وگرنه نمی توانیم آنها را به بسته شدن تحویل دهیم.
//
//همچنین، قوانین همزمانی در اینجا مانند همه جا اعمال می شود. اگر مقداری را در آرایه اعداد تغییر دهیم در حالی که رشته‌ها در حال اجرا هستند، هیچ تضمینی وجود ندارد که آن‌ها آن را بدون ارائه مقداری همگام‌سازی ببینند.
//
//و برای جمع‌بندی در اینجا، یک کلاس داخلی ناشناس نیز کار می کند، می گویند اگر از نسخه قدیمی جاوا استفاده می کنیم
